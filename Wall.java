...
public class Wall {
	...
	{
		//returns coords that aren't at the corners so you can connect them
		//to another wall with a hallway
	...
	{
		//checks if two walls have VIABLE overlap
	...
	{
		//returns two coords that form a straight line from one wall to the other
		//precondition: room this and b have to overlap
		if(this.overlaps(b))
		{
			if(this.getVert())
			{
	...
	{
		//returns a pair of valid spots that one could form a corner from
		//precondition: a and b have different vertical parity
