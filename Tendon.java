...
public class Tendon {
	...
	{
		//returns the coords in a given tendon
		//does this by drawing out the lines (making line classes of each leg and adding them)
	...
	{
		//returns all the coords involved by adding the lines together
		int holdNum = 0;
	...
	{
		//same as above, adds the line lists together
		//except here it's for two lines instead of 3
		int holdNum = 0;
