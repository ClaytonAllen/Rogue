...
public class Room {
	...
	{
		//generates a random value between a min and max value (inclusive)
	...
	{
		//checks if this room has a coord in it within a given buffer
	...
	{
		//checks for room conflict with a room and this room within the buffer 
	...
	{
		//converts this room to a wallset
	...
	public Tendon getTendon(Room b)
	{
		...
		//takes a room and finds a valid tendon to it
	...
	{
		//finds a wallPair (two walls and a viable line pattern)
		//between two rooms and returns it
		...
		//check for direct overlap, return a good wallPair directly for it to work
	...
	{
		//gets the pythagorean distance between this room and a given room
		return(Math.sqrt(
	...
	{
		//adds a room to the connected list
	...
	{
		//checks if a room is on the list of connected rooms
